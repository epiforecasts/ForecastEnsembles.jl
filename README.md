...
[epiforecasts.io/ForecastEnsembles.jl](https://epiforecasts.io/ForecastEnsembles.jl/stable/).
The [Methods](https://epiforecasts.io/ForecastEnsembles.jl/stable/methods) page
...
We welcome contributions and new contributors! Please open an issue or pull request on [GitHub](https://github.com/EpiAware/ForecastEnsembles.jl). This package follows [ColPrac](https://github.com/SciML/ColPrac) and the [SciML style](https://github.com/SciML/SciMLStyle).

## How to cite

If you use ForecastEnsembles in your work, please cite it. Citation metadata lives in [`CITATION.cff`](https://github.com/EpiAware/ForecastEnsembles.jl/blob/main/CITATION.cff), which GitHub renders as a "Cite this repository" button on the repository page.
