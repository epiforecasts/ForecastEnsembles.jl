...
```@meta
EditURL = "https://github.com/epiforecasts/ForecastEnsembles.jl/blob/main/NEWS.md"
```
...
See [GitHub Releases](https://github.com/epiforecasts/ForecastEnsembles.jl/releases) for minor/patch
release information.
